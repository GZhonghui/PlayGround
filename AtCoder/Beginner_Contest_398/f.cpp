...
void main_algo() {
    ...
    hashable_string::hashable_string_segment_tree seg;
    seg.set(s);

    reverse(s.begin(), s.end());
    hashable_string::hashable_string_segment_tree rev;
    rev.set(s);
